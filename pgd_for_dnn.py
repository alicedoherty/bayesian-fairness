...
measurements = [ "DNNAccuracy",  "DNNBasicScore",
                "DNNMaxDifference",  "DNNMinDifference",  "DNNMeanDifference"]
...
f = open(f"./results/trial_{datetime.now()}_eps_{epsilon}_pgd_folks_dnn.csv", 'a')
print(df, file=f)
f.close()
